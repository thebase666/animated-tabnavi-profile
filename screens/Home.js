...
import { FlatList } from 'react-native-gesture-handler';//FlatList horizontal不work就用gesture的FlatList 
import { useNavigation } from '@react-navigation/native';
import {
  IconButton, TextButton, VerticalCourseCard,
  LineDivider, CategoryCard, Section, HorizontalCourseCard
} from '../components';
    ...
    return (
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <VerticalCourseCard
            containerStyle={{
              margin: 5, // if last item, then give more margin
            }}
            course={item}
          />
        )}
